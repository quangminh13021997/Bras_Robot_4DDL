...
axes(handles.axes2);
imshow('D:\GiaiBaiTap\KyThuatRobot\FINAL\Final(NOP)\ZIP\testMLNop\HCMUTE.PNG');
...
%        get(hObject,'Min') and get(hObject,'Max') to determine range of slider
    ModelName = 'Ass_Bras4DDL';
    global var;
    t1=get(handles.slider1,'value'); % valeur of slider
    set(handles.edit1,'string',num2str(t1));%print valeur on slider 
    ...
    set_param([ModelName '/Slider Gain'],'Gain',num2str(t1)) %Transmis valeurs from SLIDER to SLIDER GAIN
